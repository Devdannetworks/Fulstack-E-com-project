...
const saveOrderToDB = async (
  ...
  try {
    ...
    const orderDoc = await addDoc(ordersRef, {
      ...
      deliveryStatus: "pending", // You can update this status as per your workflow
      paymentStatus: "pending", // You can update this status as per your workflow
    });

    console.log("Order saved to the database");
    return orderDoc.id; // Return the generated orderId
  } catch (error) {
